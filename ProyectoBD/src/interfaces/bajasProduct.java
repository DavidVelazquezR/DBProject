 ...
 * @author david
 */
public class bajasProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLTitulo.setText("Bajas de productos");
        ...
        jPanel1.add(jBEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(348, 138, -1, -1));
    ...
    private void jBLimpiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBLimpiaActionPerformed
        ...
        CtrlInterfaz.habilita(false, jBIngresar, jBEliminar);
    ...
    private void jBIngresarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBIngresarKeyPressed
        if (evt.getKeyChar() == '\n') {
            ...
            Validaciones.enter(this, evt, jBEliminar);
        }
    ...
    private void jBIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBIngresarActionPerformed
        ...
        if (flag) {
            ...
            CtrlInterfaz.habilita(true, jBEliminar);
            flag = false;
        }
    ...
    private void jBEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarActionPerformed
        ...
        if (Mensaje.pregunta(this, "¿Esta seguro de que desea eliminar el siguiente registro?") == JOptionPane.YES_OPTION) {
            Querys q = new Querys();
            try {
                q.Delete(con, "producto", "id",  jTFIDProduct.getText());
            } catch (Exception e) {
                System.out.println("Error en el INSERT...exception ->" + e);
            }
    ...
    private void jBEliminarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBEliminarKeyPressed
        if (evt.getKeyChar() == '\n'){
            jBEliminarActionPerformed(null);
        }
