 ...
 * @author david
 */
public class modificaProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jBIngresar.setText("Mostrar producto");
        ...
        jLTitulo.setText("Modificación de productos");
        jPanel1.add(jLTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 54, -1, -1));
        ...
        jPanel1.add(jBLimpia, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 138, -1, -1));
        ...
        jBModify.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jBModifyKeyPressed(evt);
            }
        });
        jPanel1.add(jBModify, new org.netbeans.lib.awtextra.AbsoluteConstraints(348, 138, -1, -1));
    ...
    private void jBLimpiaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBLimpiaActionPerformed
        ...
        CtrlInterfaz.habilita(false, jBIngresar, jBModify, jTFCant, jTFCantMM, jTFNomProduct, jTFPrecComp
        , jTFPrecVM, jTFPrecVU);
    ...
    private void jTFCantMMKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFCantMMKeyPressed
        Validaciones.enterFlotante(this, evt, jTFCantMM,jBModify);
    ...
    private void jBIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBIngresarActionPerformed
        ...
        if (flag) {
            ...
            CtrlInterfaz.habilita(true, jBModify);
            flag = false;
        }
    ...
    private void jBModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBModifyActionPerformed
        ...
        if (Mensaje.pregunta(this, "¿Esta seguro de que desea modificar el siguiente registro?") == JOptionPane.YES_OPTION) {
            Querys q = new Querys();
            String columnas = "id,descripcion,cantidad,preciocomp,precioventaun,precioventama,cantmayoreo";
            String values = "'" + jTFIDProduct.getText() + "',"
                    + "'" + jTFNomProduct.getText() + "',"
                    + "'" + jTFCant.getText() + "',"
                    + "'" + jTFPrecComp.getText() + "',"
                    + "'" + jTFPrecVU.getText() + "',"
                    + "'" + jTFPrecVM.getText() + "',"
            ...
            try {
                q.Modificar(con, "producto",columnas, values, "id = " + jTFIDProduct.getText());
            } catch (Exception e) {
    ...
    private void jBModifyKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBModifyKeyPressed
        if (evt.getKeyChar() == '\n'){
            jBModifyActionPerformed(null);
        }
    }//GEN-LAST:event_jBModifyKeyPressed
